...
$locale = array (
	'comment-form'		=> 'Escriba un comentario aquí (otros campos son opcionales)',
	'reply-form'		=> 'Escriba su respuesta aquí (otros campos opcionales)',
	'form-tip'		=> 'HTML Aceptado: &lt;b&gt;, &lt;u&gt;, &lt;i&gt;, &lt;s&gt;, &lt;pre&gt;, &lt;ul&gt;, &lt;ol&gt;, &lt;li&gt;, &lt;blockquote&gt;, &lt;code&gt; escapa, Las URLs automágicamente se vuelven links, y [img] URL de imagen [/img] mostrará una imagen externa.',
	...
	'name'			=> 'Nombre',
	'name-tip'		=> 'Nombre (opcional)',
	'password'		=> 'Contraseña',
	'password-tip'		=> 'Contraseña (opcional, le permite editar o eliminar su comentario)',
	'confirm-password'	=> 'Confirmar Contraseña',
	'email'			=> 'E-mail',
	'email-tip'		=> 'Dirección de correo electrónico (para notificaciones, opcional)',
	'website'		=> 'Sitio Web',
	'website-tip'		=> 'Sitio Web (opcional)',
	...
	'sort'			=> 'Ordenar',
	'sort-ascend'		=> 'En Orden',
	'sort-descend'		=> 'En Orden Inverso',
	'sort-byname'		=> 'Por Comentarista',
	'sort-bydate'		=> 'Reciente Primero',
	'sort-bylikes'		=> 'Por Popularidad',
