...
$locale = array (
	'comment-form'		=> 'ここにコメントを入力し（その他のフィールドはオプショナル）',
	'reply-form'		=> 'ここに返信を入力し（その他のフィールドはオプショナル）',
	...
	'name-tip'		=> '名字 (オプショナル)',
	'password'		=> 'パスワード',
	'password-tip'		=> 'パスワード（オプショナル, 編集またはこのコメント削除することができます）',
	'confirm-password'	=> '確認パスワード',
	'email'			=> 'メールアドレス',
	'email-tip'		=> 'メールアドレス (オプショナル, 電子メール通知のための)',
	'website'		=> 'ウェブサイト',
	'website-tip'		=> 'ウェブサイト (オプショナル)',
