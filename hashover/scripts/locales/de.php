...
$locale = array (
	...
	'accepted-markdown'	=> '**Fett**, _unterstrichen_, *kursiv*, ~~durchgestrichen~~, `markieren`, ```code``` entweicht HTML. HTML und Markdown können zusammen in Ihrem Kommentar verwendet werden.',
	...
	'date-month-names'	=> array ('Januar', 'Februar', 'März', 'April', 'Kann', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember'),
	'untitled'		=> 'Ohne Titel',
